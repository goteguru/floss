...
\titlehead{
	...
	\textsc{Katonai Műszaki Doktori Iskola}
	}
	\end{center}
}
\title{\setstretch{1.0}Létfontosságú Információs Rendszerelemekben alkalmazott nyílt forráskód
és szabad szoftver rendszerszemléletű biztonsági analízise}
\subtitle{\normalfont Doktori (PhD) értekezés tervezet}
\subject{\textbf{Mészáros Gergely}}
\date{}
\author{
Témavezetők: \\
...
\centering
\includegraphics{ábrák/punch_hierarchy.pdf}
...
\hypertarget{fig:RQ}{%
\centering
\includegraphics{ábrák/Research_Questions.pdf}
...
szerint]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-Year-TYP.svg}\label{fig:SMSYearTYP}}
\subfloat[Publikáció témája
szerint]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-Year-TOP.svg}\label{fig:SMSYearTOP}}

\subfloat[FLOSS tulajdonság szerinti
osztályozás]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-Year-OSP.svg}\label{fig:SMSYearOSP}}
\subfloat[Módszertan szerinti
osztályozás]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-Year-MTH.svg}\label{fig:SMSYearMTH}}
...
módszertan]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-OSP-MTH.svg}\label{fig:SMSOSPMTH}}
...
\subfloat[Publikáció típusonként jellemző
eredményfajták]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-OSP-CTR.svg}\label{fig:SMSOSPCTR}}
\subfloat[Publikáció típusok biztonsági
területenként]{\includegraphics[width=0.5\textwidth,height=\textheight]{ábrák/SMS-TYP-SEC.svg}\label{fig:SMSTYPSEC}}
...
\centering
\includegraphics{ábrák/hagyma-modell.pdf}
...
\centering
\includegraphics{ábrák/alter.png}
